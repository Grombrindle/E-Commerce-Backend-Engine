...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            ['category_id' => $electronics?->id, 'name' => 'Sony WH-1000XM5',     'price' => 349.99,  'compare_price' => 399.99,  'sku' => 'ELEC-SONYWH5',     'stock' => 8],   // Low stock
            ...
            ['category_id' => $clothing?->id,    'name' => 'Winter Parka',        'price' => 199.99,  'compare_price' => null,    'sku' => 'CLTH-WIN-PRK',     'stock' => 0],   // Out of stock
            // Sports
            ...
            ['category_id' => $sports?->id,      'name' => 'Protein Powder 2kg',  'price' => 49.99,   'compare_price' => 59.99,   'sku' => 'SPRT-PROT-2KG',    'stock' => 5],   // Low stock
        ];
